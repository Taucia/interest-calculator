...
function compoundInterest() {
  ...
  document.getElementById("ciOutput-01").innerHTML = "Interest: R" + (amount - principal).toFixed(2);
  document.getElementById("ciOutput-02").innerHTML = "Total plus interest: R" + amount;
}